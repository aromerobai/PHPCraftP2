...
<button onclick="redirectToUsuarioVista('<?php echo urlencode($id); ?>', '<?php echo urlencode($username); ?>', '<?php echo urlencode($password); ?>', '<?php echo urlencode($email); ?>')" class="btn btn-block btn-secondary align-self-end">Volver</button>
</body>
</html>
